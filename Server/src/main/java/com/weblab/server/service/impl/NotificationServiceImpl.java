...
public class NotificationServiceImpl implements NotificationService {
     ...
     */
    @Override
    public <T, D> Boolean addNotification(T t, D d) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        ...
        if (tClass.getMethod("getStudentId") != null) {
            ...
            Long teacherId = (Long)dClass.getMethod("getByCourseId").invoke(d, courseId);
